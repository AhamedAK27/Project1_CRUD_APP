...
app.config['UPLOAD_FOLDER'] = 'C:/Users/mzaah/Desktop/My Files/UNI Doc/FocalID/Project1_CRUD_APP/photo'
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=int(3000), debug=True) #while developing webapp place debug =True & remove while deploy
